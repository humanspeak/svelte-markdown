...
**Integrated** — [PR #355](https://github.com/humanspeak/svelte-markdown/pull/355) opened via the `pr` skill for the reviewed snapshot commit (`5dbf32b`). Merging is the operator's call; guard never merges.
